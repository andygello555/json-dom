...
var checkStdoutErr = map[string]map[string][]string{
	...
	"json_path": {
		"stdout": []string{
			...
			"Print call from: <$>:23:1",
			"map[0:map[name:Jayden Welch] 1:map[age:20 name:Louis Warren] 2:map[age:83 name:Libby Willis] 3:map[age:81 name:Mohammad Sutton] 4:map[age:49 name:Katie Cole] 5:map[age:42 name:Molly Little] 6:map[age:62 name:Daniel Booth] 7:map[age:84 name:Oscar Hodgson] 8:map[name:Libby Ross] 9:map[age:20 name:Ava Forster]] 10",
			"Print call from: <$>:37:5",
